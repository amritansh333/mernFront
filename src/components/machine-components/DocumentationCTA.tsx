...
export default function DocumentationCTA({ title }: DocumentationCTAProps) {
  return (
      ...
      <div className="grid lg:grid-cols-[59%_41%]">
        ...
        <div className="border-t border-[#279ECE]/10 bg-white/45 p-5 lg:border-l lg:border-t-0 lg:p-6">
          <p className="text-[14px] leading-8 text-[#5C7696]">
            ...
            <span className="font-semibold text-[#279ECE]">{title}</span> with
            technical specifications, material details, dimensions,
