...
const TEMP_RANGES = [
  {
    ...
    label: "Cryogenic",
    range: "< −100°C",
    description: "Liquid nitrogen, LNG, cryogenic storage",
  },
  {
    id: "low",
    label: "Low",
    range: "−100 to −20°C",
    description: "Freezer, refrigeration, cold storage",
  },
  {
    id: "ambient",
    label: "Ambient",
    range: "−20 to +80°C",
    description: "Standard industrial, room temperature",
  },
  {
    id: "elevated",
    label: "Elevated",
    range: "+80 to +150°C",
    description: "Hot processing, steam, warm fluids",
  },
  {
    id: "high",
    label: "High",
    range: "+150 to +260°C",
    description: "Autoclave, high-temp chemical processes",
  },
  {
    id: "extreme",
    label: "Extreme",
    range: "> +260°C",
    description: "Only specialist materials apply",
  },
];
...
const LOAD_TYPES = [
  {
    id: "static",
    label: "Static Load",
    desc: "Structural, clamping, fastening — no movement",
  },
  {
    id: "sliding",
    label: "Sliding / Low-friction",
    desc: "Seals, bearings, wear surfaces in slow motion",
  },
  {
    id: "dynamic",
    label: "Dynamic / Impact",
    desc: "Repeated loading, shock, vibration, impact",
  },
  {
    id: "abrasive",
    label: "Abrasive Wear",
    desc: "Bulk materials, scraping, high sliding wear",
  },
  {
    id: "electrical",
    label: "Electrical Insulation",
    desc: "Dielectric use, ESD-sensitive environments",
  },
];
...
const MATERIALS_DB = [
  {
    id: "polyrib-v",
    name: "POLYRIB V",
    full: "UHMW Polyethylene — Polyrib's abrasion & impact grade",
    scores: {
      cryo: 5,
      low: 5,
      ambient: 5,
    ...
    keyProps:
      "Highest abrasion resistance, self-lubricating, food grade & antistatic grades",
    maxTemp: "+80°C",
    minTemp: "−200°C",
  ...
  },
  {
    id: "polyrib-h",
    name: "POLYRIB H",
    full: "HDPE — Polyrib's chemical resistance & outdoor durability grade",
    scores: {
      cryo: 3,
      low: 4,
      ambient: 5,
    ...
    keyProps:
      "Chemical resistance, UV-stabilised, glass-lined FRP grades, marine rated",
    maxTemp: "+80°C",
    minTemp: "−60°C",
    colour: "Natural / Black / Colours",
    forms: "Sheets, Boards, Rolls",
  ...
  },
  {
    id: "polyrib-p",
    name: "POLYRIB P",
    full: "Polypropylene — Polyrib's chemical tank & fabrication grade",
    scores: {
      cryo: 0,
      low: 1,
      ambient: 5,
    ...
    keyProps:
      "Outstanding acid/alkali resistance, weldable for tank fabrication, RIPLA cutting board grades",
    maxTemp: "+100°C",
    minTemp: "−10°C",
    colour: "Natural / Grey",
    forms: "Sheets, Blocks, Boards",
  ...
  },
  {
    id: "pcclear",
    name: "PCCLEAR",
    full: "Polycarbonate — Polyrib's high-clarity glazing & display grade",
    scores: {
      cryo: 2,
      low: 3,
      ambient: 5,
    ...
    keyProps:
      "250× stronger than glass, high optical clarity, UV-protected & hard coat grades",
    maxTemp: "+120°C",
    minTemp: "−40°C",
  ...
  },
  {
    id: "pakaylon",
    name: "PAKAYLON",
    full: "Cast PA6 Nylon — Polyrib's wear-resistant engineering rod & block",
    scores: {
      cryo: 2,
      low: 3,
      ambient: 5,
    ...
    keyProps:
      "Toughness, wear resistance, oil-impregnated & MoS₂ grades, self-lubricating",
    maxTemp: "+120°C",
    minTemp: "−40°C",
    colour: "Natural / Black / Blue",
  ...
  },
  {
    id: "paketal",
    name: "PAKETAL",
    full: "Acetal / POM — Polyrib's precision machining grade",
    scores: {
      cryo: 2,
      low: 3,
      ambient: 5,
    ...
    keyProps:
      "Finest precision machinability, dimensional stability, low friction",
    maxTemp: "+100°C",
    minTemp: "−40°C",
    colour: "Natural / Black",
    forms: "Rods, Tubes, Sheets",
  ...
  },
  {
    id: "dipra",
    name: "DIPRA",
    full: "PP Gate Liners & Roof Liners — Polyrib's specialist PP range",
    scores: {
      cryo: 0,
      low: 1,
      ambient: 5,
    ...
    keyProps:
      "UV-fast roof liners, gate liner grades, embossed non-slip, dual-colour for signage",
    maxTemp: "+100°C",
    minTemp: "−10°C",
    colour: "Multiple colours",
    forms: "Sheets, Rolls, Film",
...
function scoreProduct(
  ...
  chemIds.forEach((c) => {
    total += (mat.scores[c as keyof typeof mat.scores] || 0) * 2;
  });
...
export default function MaterialSelectorPage() {
  ...
  const results = showResults
    ? MATERIALS_DB.map((mat) => {
        ...
        const raw = scoreProduct(
          mat,
          tempId,
          chemIds.length ? chemIds : ["none"],
          loadId,
        );
      ...
      <div className="bg-surface-subtle border-b border-divider py-12">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            Answer three questions about your application requirements and we'll
            rank the most suitable thermoplastic materials for your specific use
            case.
          </p>
        </div>
      </div>
      ...
      <div className="container max-w-5xl mx-auto px-6 py-12">
        {!showResults ? (
          <>
            ...
            <div className="flex items-center gap-3 mb-10">
              {[0, 1, 2].map((s) => (
                <div key={s} className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-sm font-medium ${s === step ? "text-charcoal" : "text-muted-foreground"}`}
                  >
                    {
                      [
                        "Temperature Range",
            ...
            {step === 0 && (
              <div className="animate-fade-in">
                ...
                <p className="text-muted-foreground text-sm mb-8">
                  Select the expected continuous service temperature for your
                  application.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {TEMP_RANGES.map((t) => (
                    ...
                    >
                      ...
                      <div className="font-mono text-primary text-sm font-bold mb-1">
                        {t.range}
                      </div>
            ...
            {step === 1 && (
              <div className="animate-fade-in">
                ...
                <p className="text-muted-foreground text-sm mb-8">
                  Select all media the material will be exposed to. Leave all
                  unchecked if dry service.
                </p>
            ...
            {step === 2 && (
              <div className="animate-fade-in">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-heading text-2xl text-charcoal">
                    What is the mechanical load type?
                  </h2>
                </div>
                <p className="text-muted-foreground text-sm mb-8">
                  Select the primary mechanical demand on the material in
                  service.
                </p>
            ...
            <div className="flex items-center justify-between mt-10 pt-8 border-t border-divider">
              ...
              <div className="flex items-center gap-3">
                ...
                {step < 2 ? (
                  ...
                  <button
                    onClick={() => {
                      if (canProceed) setShowResults(true);
                    }}
                    disabled={!canProceed}
                    className={`inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold transition-colors duration-200 ${canProceed ? "bg-primary text-primary-foreground hover:bg-primary-dark" : "bg-muted text-muted-foreground cursor-not-allowed"}`}
                  >
          ...
          <div className="animate-fade-in">
            ...
            <div className="bg-primary/5 border border-primary/20 p-4 mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex flex-wrap gap-3 text-xs">
                <span className="flex items-center gap-1.5 text-charcoal-light">
                  ...
                  {TEMP_RANGES.find((t) => t.id === tempId)?.range}
                </span>
                {chemIds.length > 0 && (
                  <span className="flex items-center gap-1.5 text-charcoal-light">
                    ...
                    {chemIds
                      .map(
                        (c) =>
                          CHEMICAL_EXPOSURES.find((e) => e.id === c)?.label,
                      )
                      .join(", ")}
                  </span>
                )}
                <span className="flex items-center gap-1.5 text-charcoal-light">
                  ...
                  {LOAD_TYPES.find((l) => l.id === loadId)?.label}
                </span>
              </div>
              <button
                onClick={reset}
            ...
            <p className="text-muted-foreground text-sm mb-8">
              Ranked by suitability for your specified requirements. Contact our
              technical team to confirm selection.
            </p>
            ...
            <div className="space-y-4">
              {results.map((mat, i) => {
                ...
                return (
                  <div
                    key={mat.id}
                    className={`border p-6 transition-all duration-200 hover:shadow-card ${i === 0 ? "border-primary/40 bg-primary/3" : "border-border bg-card"}`}
                  >
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-8 h-8 flex items-center justify-center font-heading font-bold text-sm shrink-0 ${i === 0 ? "bg-primary text-primary-foreground" : "bg-surface-subtle text-charcoal-light border border-divider"}`}
                        >
                          #{i + 1}
                        </div>
                        <div>
                          <div className="flex items-center gap-3 mb-1 flex-wrap">
                            ...
                            <span
                              className={`text-[10px] px-2.5 py-1 border font-bold ${matchInfo.colour}`}
                            >
                              {matchInfo.label}
                            </span>
                            {i === 0 && (
                              <span className="text-[10px] px-2.5 py-1 bg-primary text-primary-foreground font-bold">
                                TOP RECOMMENDATION
                              </span>
                            )}
                          </div>
                    ...
                    <div className="mt-4 flex gap-3">
                      <Link
                        to={
                          (mat as typeof mat & { href?: string }).href ||
                          "/products"
                        }
                        className="cta-link text-xs"
                      >
                        View {mat.name} products{" "}
                        <ArrowRight className="w-3.5 h-3.5" />
                      </Link>
                      <Link
                        to="/contact"
                        className="text-xs px-4 py-1.5 bg-primary text-primary-foreground font-semibold hover:bg-primary-dark transition-colors duration-200 inline-flex items-center gap-1.5"
                      >
            ...
            <div className="mt-10 p-5 bg-surface-subtle border border-divider">
              <p className="text-xs text-muted-foreground leading-relaxed">
                <strong className="text-charcoal">Disclaimer:</strong> This tool
                provides general material guidance based on typical property
                profiles. Suitability scores are indicative only. Final material
                selection should always be confirmed with our technical
                engineering team, taking into account specific part geometry,
                regulatory requirements, and application-specific testing.
              </p>
            </div>
          </div>
        )}
