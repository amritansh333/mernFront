...
const POSTS = [
  {
    ...
    type: "Blog",
    title:
      "Selecting UHMW PE vs HDPE for conveyor wear strips — a practical guide",
    date: "Jan 2025",
    image: rodsImage,
    excerpt:
      "Both POLYRIB V (UHMW PE) and POLYRIB H (HDPE) are widely used for conveyor wear surfaces, but the right choice depends on load, speed, and temperature. This guide walks through the key selection criteria.",
  ...
  },
  {
    ...
    image: sheetsImage,
    excerpt:
      "Polycarbonate is 250× stronger than glass at comparable thickness. We explore where PCCLEAR grades are being specified as glass replacements in industrial, agricultural, and construction applications.",
  ...
  },
  {
    ...
    image: machineImage,
    excerpt:
      "Cast nylon (KAYLON) and acetal (PAKETAL) are both excellent choices for precision bearing and gear applications. We compare their mechanical properties, machinability, and recommended applications.",
  ...
  },
  {
    ...
    excerpt:
      "Polyrib exhibited our full automotive thermoplastics range at Automechanika Mumbai 2024. Highlights included our PLASCON-V machine component grades and KBK ABS automotive interior sheets.",
  ...
  },
  {
    ...
    image: foodImage,
    excerpt:
      "A practical overview of food-contact compliance requirements for thermoplastic components. Which Polyrib grades carry FDA and EU food contact certification — and what that means in practice.",
  ...
  },
  {
    ...
    image: pharmaImage,
    excerpt:
      "Our new dedicated DIPRA production line for UV-stabilised PP speciality sheets came online in August 2024, doubling our capacity for DIPRA PPGL roofing liners and DIPRA embossed gate liners.",
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-2">
            {["All", "Blog", "Gallery"].map((f) => (
              <button
                key={f}
                className="px-4 py-1.5 text-sm font-semibold border border-border bg-card text-charcoal-light hover:border-primary hover:text-primary transition-all duration-200"
              >
                {f}
              </button>
            ))}
            ...
            <div key={post.id} className="product-card flex flex-col group">
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                  <span
                    className={`text-[10px] px-2.5 py-1 font-bold ${TYPE_COLOURS[post.type] || ""}`}
                  >
                    {post.type}
                  </span>
