...
const CATALOGS = [
  {
    ...
    description:
      "Complete range of Polyrib polymer sheets and engineering plastics",
    pages: "16 pages",
    format: "PDF",
    size: "2.5 MB",
    updated: "Feb 2026",
  ...
  },
  {
    ...
    description:
      "High-quality plastic sheets for industrial and commercial applications.",
    pages: "7 pages",
    format: "PDF",
    size: "5.3 MB",
    updated: "Jan 2026",
  ...
  },
  {
    ...
    description:
      "High-quality cutting boards for leather, textile and soft materials cutting.",
    pages: "4 pages",
    format: "PDF",
    size: "1.4 MB",
    updated: "Dec 2025",
  ...
  },
  {
    ...
    description:
      "UV resistant fabric backed extruded plastic sheets for roofing.",
    pages: "4 pages",
    format: "PDF",
    size: "1.3 MB",
    updated: "Nov 2025",
  ...
  },
  {
    ...
    description:
      "Chemical engineering polymer sheets for industrial applications.",
    pages: "8 pages",
    format: "PDF",
    size: "0.4 MB",
    updated: "Feb 2026",
  ...
  const handleDownload = async (e) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/api/catalogrequests`,
        {
          method: "POST",
          headers: {
      ...
      <div className="bg-surface-subtle border-b border-divider py-12">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            Download our product catalogues and brand brochures to explore the
            full range of Polyrib thermoplastic grades, specifications, and
        ...
        <div className="container max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {CATALOGS.length} catalogues and brochures available
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {CATALOGS.map((doc) => (
              <div
                key={doc.id}
                className="product-card flex flex-col group border border-border hover:border-primary/40 transition-all duration-300 hover:shadow-card-hover"
              >
                {/* Top stripe */}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className={`text-[10px] font-semibold px-2.5 py-1 border ${TAG_COLORS[doc.tag] ?? "bg-surface-subtle text-muted-foreground border-divider"}`}
                    >
                      {doc.tag}
                    </span>
        ...
        <div className="container max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-white/60 text-sm">
              Send us your engineering drawing and our team will respond within
              48 hours.
            </p>
          </div>
          <div className="flex gap-3 shrink-0">
            ...
            <Link
              ...
              className="px-5 py-2.5 border border-white/20 text-white text-sm font-semibold hover:bg-white/10 transition-colors duration-200"
            >
              Send Your Drawing
            </Link>
          </div>
