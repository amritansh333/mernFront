...
const MATERIAL_FAMILIES = [
  {
    ...
    grades: [
      ...
      "POLYRIB-L-V",
      "POLYRIB-V030",
      "POLYRIB-V SUPERSLIDE",
      "POLYRIB-V-AS (Antistatic)",
      "POLYRIB-V-FR (Flame Retardant)",
      "POLYRIB-V FG (Food Grade)",
      "POLYRIB-C",
    ],
    industries: [
      "Food & Beverage",
    ...
    keyProps: [
      ...
      "FDA food-grade grades",
      "Antistatic and FR grades",
      "Cryogenic service (−200°C)",
  ...
  },
  {
    ...
    grades: [
      "PCCLEAR LIGHT (Transparent, no UV)",
      "PCCLEAR UV LIGHT (Transparent + UV)",
      "PCCLEAR GLAZE (Embossed, no UV)",
      "PCCLEAR GLAZE UV (Embossed + UV)",
      "PCCLEAR GLAZE DIAMOND (Diamond embossed)",
      "PCCLEAR SHADE (Tinted)",
      "PCCLEAR OPAL (Opaque)",
      "PCCLEAR BASE PLATE",
      "PCCLEAR RIB",
      "PCCLEAR LOUVERS",
  ...
  },
  {
    ...
    grades: [
      "POLYRIB PPX-258 (Chemical tanks)",
      "POLYRIB PPX-259 (High impact)",
      "POLYRIB PGX-266 (PP/FRP glass-backed)",
      "POLYRIB PGX-226",
      "POLYRIB HITECH",
      "POLYRIB HITECH GL",
      "POLYRIB RIPLA HIH",
      "POLYRIB RIPLA HIK",
      "POLYRIB RIPLA HITECH",
      "POLYRIB-P-HIH CED",
      "POLYRIB-PPC-CED",
      "POLYRIB PP AS (Antistatic)",
      "DIPRA AD CLEAR",
      "DIPRA EMBOSSED GATE LINER",
      "DIPRA PPGL UVIOFAST ROOF LINER",
      "POLYRIB PP UV",
      "POLYRIB PP DUAL",
      "POLYRIB PP TF",
    ],
  ...
  },
  {
    ...
    grades: [
      "POLYRIB-H EXT",
      "POLYRIB-H CED",
      "POLYRIB-H 452 (Thermoforming)",
      "POLYRIB-H 92",
      "POLYRIB-HGX-266-EXT (Glass Lined)",
      "POLYRIB-ARETE L-H",
      "POLYRIB-HXM-001 EXT (PE100)",
      "POLYRIB-H-PLAY EMB UV",
      "POLYRIB CUTRITE EMB",
      "POLYRIB- LD (LDPE)",
      "POLYRIB-H WR (Welding Rod)",
    ],
    industries: [
      "Aerospace",
      "Agriculture",
  ...
  },
  {
    ...
    grades: [
      "KAYLON NATURAL",
      "KAYLON OILON (Oil-filled, improved PV)",
      "KAYLON HS BLUE (Heat & UV stabilised)",
      "KAYLON MOLY (MoS₂ filled, low CoF)",
      "KAYLON BLACK (Heat stabilised)",
    ],
    industries: ["Automotive", "Food & Beverage", "Heavy Equipment", "Marine"],
    keyProps: [
      "Excellent wear resistance",
      "Oil-impregnated grades",
      "MoS₂ low-friction grades",
      "Heat-stabilised grades",
      "For gears, bearings, pads",
  ...
  },
  {
    ...
    keyProps: [
      "Best machinability of all thermoplastics",
  ...
  },
  {
    ...
    grades: [
      "KBK ABS EMBOSSED GLOSSY",
      "KBK ABS EMBOSSED MATT",
      "KBK ABS/ASA EMBOSSED & PLAIN",
      "KBK ABS ACRYLIC EMBOSSED & PLAIN",
      "KBK ASA SHEETS",
      "KBK ABS DUAL (Co-extruded)",
      "KBK ABS FR UV (Fire Retardant)",
      "KBK A WR3D (3D printer filament)",
      "KBK A CED (Thick, rapid prototyping)",
    ],
    industries: ["Automotive", "Signage", "Display & POP"],
    keyProps: [
      "Excellent surface finish",
      "UV-stabilised ASA for outdoors",
      "Dual-colour co-extruded",
      "Fire retardant grade",
      "3D printing filament grade",
  ...
  },
  {
    ...
    grades: [
      "PLASCON-V (Stress-relieved UHMW PE)",
      "PLASCON-V PIGMENTED (Lubricant-added)",
      "PLASCON GB ORANGE",
      "PLASCON MOS2 GREY",
      "PLASCON-HI-TECH CERA",
      "PLASCON-RIDER BLACK",
      "PLASCON-RIDER GLIDE BLACK",
      "PLASCON KATROS BLACK",
      "PLASCON M",
    ],
    industries: ["Automotive", "Food & Beverage", "Heavy Equipment"],
    keyProps: [
      "Stress-relieved for machining",
      "Reduced warping post-machining",
      "Improved sliding properties",
      "Lubricant-filled grades",
      "Best dimensional stability",
      "Machine component focussed",
    ],
    maxTemp: "+80°C",
    minTemp: "−200°C",
  },
  {
    ...
    keyProps: [
      "UV-stabilised outdoor grades",
      "Cloth-lined roofing liner",
      "Embossed vacuum forming",
      "Talc-filled for stiffness",
      "Dual-colour co-extruded",
      "Gate and door liner applications",
    ],
    maxTemp: "+100°C",
    minTemp: "−10°C",
  },
...
export default function MaterialsPage() {
  ...
  const mat = selected
    ? MATERIAL_FAMILIES.find((m) => m.slug === selected)
    : null;
      ...
      <div className="bg-surface-subtle border-b border-divider py-12">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            Polyrib manufactures a comprehensive range of thermoplastics under
            its brand families. Click any brand to explore its grades,
              ...
              <React.Fragment key={m.slug}>
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <span
                      className={`text-[10px] px-2.5 py-1 font-bold border ${m.colour}`}
                    >
                      {m.base}
                    </span>
                    <ChevronRight
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      <div className="lg:col-span-2">
                        <div className="flex items-center gap-3 mb-4 flex-wrap">
                          ...
                          <span
                            className={`text-xs px-2.5 py-1 border font-bold ${m.colour}`}
                          >
                            {m.base}
                          </span>
                        </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                          <Link
                            to="/contact"
                            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground text-xs font-semibold hover:bg-primary-dark transition-colors duration-200"
                          >
                            Request Quote for {mat.brand}{" "}
                            <ArrowRight className="w-3.5 h-3.5" />
                          </Link>
                          <Link
                            to="/resources"
                            className="inline-flex items-center justify-center gap-2 px-4 py-2 border border-border text-xs font-semibold text-charcoal-light hover:border-primary hover:text-primary transition-colors duration-200"
                          >
                            Download Datasheet
                          </Link>
                        </div>
        ...
        <div className="mt-12 border border-border p-6 flex flex-col md:flex-row items-center justify-between gap-5 bg-surface-subtle">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Use our Material Selector tool or speak to our technical team.
            </p>
          </div>
