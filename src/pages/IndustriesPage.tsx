...
const FEATURED_INDUSTRIES = [
  {
    ...
    stats: [
      { v: "POLYRIB-H EXT", l: "Marine HDPE" },
      { v: "POLYRIB V", l: "Dock Wear Plates" },
      { v: "POLYRIB H", l: "Pontoon Decking" },
    ],
  },
  {
  ...
  },
  {
    ...
    stats: [
      { v: "KAYLON", l: "Gears & Bearings" },
      { v: "POLYRIB V", l: "Conveyor Liners" },
      { v: "PAKETAL", l: "Precision Parts" },
    ],
  },
  {
  ...
  },
  {
    ...
    image: chemicalImage,
    stats: [
      { v: "POLYRIB P", l: "Chemical Tanks" },
      { v: "POLYRIB H", l: "HDPE Linings" },
      { v: "DIPRA", l: "Gate Liners" },
    ],
  },
  {
    slug: "food-beverage",
    ...
    image: foodBevImage,
    stats: [
      { v: "FDA", l: "21 CFR Compliant" },
      { v: "POLYRIB-V FG", l: "Food Grade PE" },
      { v: "CUTRITE", l: "HACCP Boards" },
    ],
  },
  {
  ...
  },
  {
    ...
    image: medicalImage,
    stats: [
      { v: "POLYRIB-V FG", l: "FDA Compliant" },
      { v: "PAKETAL", l: "Precision Parts" },
      { v: "PCCLEAR", l: "Enclosures" },
    ],
  },
  {
    slug: "mining",
    ...
    image: miningImage,
    stats: [
      { v: "POLYRIB V", l: "Chute Liners" },
      { v: "POLYRIB-V-FR", l: "FR Underground" },
      { v: "ARETE", l: "FRP Composites" },
    ],
  },
  {
    slug: "oil-gas",
    ...
    image: oilGasImage,
    stats: [
      { v: "POLYRIB-V-AS", l: "ATEX Rated" },
      { v: "KAYLON OILON", l: "Pump Bearings" },
      { v: "PAKETAL", l: "Valve Parts" },
    ],
  },
      ...
      <div className="bg-surface-subtle border-b border-divider py-8">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            Polyrib thermoplastic materials are trusted across 20+ industries
            worldwide — from food processing and automotive to mining, oil &
            gas, and medical device manufacturing.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            {FEATURED_INDUSTRIES.map((ind) => (
              <Link
                ...
                className="category-card flex flex-col md:flex-row overflow-hidden group"
              >
                ...
                <div className="flex-1 p-8">
                  <h2 className="font-heading text-2xl text-charcoal mb-2 group-hover:text-primary transition-colors duration-200">
                    {ind.title}
                  </h2>
      ...
      <section className="py-12 bg-surface-subtle border-t border-divider">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-heading text-2xl text-charcoal mb-6">
            Our full industry coverage
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {ALL_INDUSTRIES.map((ind) => (
              <div
                key={ind}
                className="flex items-center gap-2 p-3 border border-border bg-card text-sm text-charcoal-light hover:border-primary hover:text-primary transition-all duration-200 cursor-default"
              >
          ...
          <p className="text-xs text-muted-foreground mt-5">
            Specific product recommendations available for each sector.{" "}
